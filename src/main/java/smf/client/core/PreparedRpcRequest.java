...
public class PreparedRpcRequest {
  ...
  public PreparedRpcRequest(final int sessionId, long methodMeta, byte[] body,
  ...
  public RpcRequestOptions
  getRpcRequestOptions() {
  ...
  hashCode() {
    ...
    int result =
      Objects.hash(sessionId, methodMeta, resultFuture, rpcRequestOptions);
